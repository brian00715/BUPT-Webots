...
// here 'bupt_webots' is the name of the package used for this node. Replace it by your own package.
#include <bupt_webots/robot_get_device_list.h>

#include <bupt_webots/get_int.h>
#include <bupt_webots/get_string.h>
...
int main(int argc, char **argv) {
  ...
  ros::ServiceClient getModelClient = n.serviceClient<bupt_webots::get_string>("/robot/get_model");
  bupt_webots::get_string getModelSrv;
  ...
  // file
  ros::ServiceClient deviceListClient = n.serviceClient<bupt_webots::robot_get_device_list>("/robot/get_device_list");
  bupt_webots::robot_get_device_list deviceListSrv;
